module.exports = {
	...
	token: "NjUzNTQxOTgwNjkyODA3Njgx.Xf6udA.iGMeRSjUTcj4dvNDIEojIY8rRio",
	/* For the support server */
	support: {
		id: "656338288755343396", // The ID of the support server
		logs: "656338288755343407", // And the ID of the logs channel of your server (new servers for example)
	},
